    ...
    function webRtcPlayer(parOptions) {
        ...
        setupDataChannel = function(pc, label, options) {
            try {
                ...
                Message.webrtc.log(`Created datachannel (${label})`)

                // Inform browser we would like binary data as an ArrayBuffer (FF chooses Blob by default!)
                datachannel.binaryType = "arraybuffer";

                datachannel.onopen = function (e) {
                  Message.webrtc.log(`data channel (${label}) connect`)
                ...
                datachannel.onclose = function (e) {
                  Message.webrtc.log(`data channel (${label}) closed`)
                }
        ...
        handleCreateOffer = function (pc) {
            ...
            function () { Message.webrtc.warn("Couldn't create offer") });
        }
        ...
        setupPeerConnection = function (pc) {
        	if (pc.SetBitrate)
        		Message.webrtc.log("Hurray! there's RTCPeerConnection.SetBitrate function");
